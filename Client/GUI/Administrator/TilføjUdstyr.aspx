<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/Site.Master" AutoEventWireup="true" CodeBehind="TilføjUdstyr.aspx.cs" Inherits="Client.GUI.Administrator.TilføjUdstyr" %>
...
&nbsp;Udlån:
    ...
    <p>
        ...
        <asp:Button ID="TilføjUdstyrButton" runat="server" Text="Tilføj udstyr" 
            CssClass="availabeButton" onclick="TilføjUdstyr_Click" />
    </p>
</asp:Content>
