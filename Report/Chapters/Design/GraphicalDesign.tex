...
Det første skærmbillede man ser når man starter programmet er listen  over lokaler og hvornår de er booket. For at book et lokale markere man tiderne i checkbokse der høre til det ønskede lokale og tryk book. Hvis man ikke er logget ind skal man logge ind først for at booke.
Grunden til man ikke skal  logge ind for at starte system op, er at vi gerne vil gøre brugeren i stand til først at se om der overhovedet er nogen ledige lokaler.
...
Når man har valgt lokale og tidspunkt, og man trykker book bliver man sendt videre til skærmbilledet der visser en liste over ens egne bookinger (se figur \ref{Design_G_Development_YourBookings_Final}). Hvis man vælger en booking og trykker "Ændre Booking" vil man blive navigeret tilbage til det først skærmbillede hvor ens booking vil markeret med blå boks, her kan man så vælge at skifte booking tidspunkt. Hvis man trykker "Tilføj Forplejning" vil man blive navigeret til skærmbilledet.
...
Figur \ref{Design_G_Development_Forplejning_Final} viser det endelige skærmbillede til valg af forplejning. For at tilføje forplejning til en booking skal man ligsom med lokale booking markere de tider man kan vil have forplejningen leveret, derudover skal man også vælge antal.
Til Designet af  skærmbillede fokuserede vi på, at det skulle minde om \ref{Design_G_Development_FinalGrid}, så vi holdte os til reglen om få vindueskabeloner. De samme designbeslutninger gælder for skærmbilleder til tilføjelse af udstyr til en booking (se appendix).
...
Man kan i skærmbilledet til booking liste makere booking i listen og enten godkend eller afvis brugerens booking ved klikk på "Godkend" eller "Afvis" knapperne.
