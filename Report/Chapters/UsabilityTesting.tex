...
\label{Usability_R1}
Efter den første runde af tests var der fem problemer. Problemerne er klassifikeret efter skalaen fra \cite[s. 439]{SL_UID}:

\paragraph{Problem 1: Task failure}
...
\paragraph{Problem 2: Cumbersome}
...
\paragraph{Problem 3: Medium problem}
...
\paragraph{Problem 4: Minor problem}
...
Konsekvenserne af testresultaterne i runde 2 ville være forslag til ændringer til næste udgave af systemet, samt mulig liste af fejl eller mangler i systemet. Disse forslag og mangler ville vi få kunden til at priotere, vi ville derefter diskutere omkostningerne af de forskellige forslag og derefter få kunden til at priotere listen igen. Usability test runde 2 vil derfor give også en prioteret liste over hvad kunden ville have implementeret og i hvilken rækkefølge.